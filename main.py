...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default=r'D:\KAIST\prev_v1\dataset', help="Root directory for raw data (used if --features_dir is not set).")
    parser.add_argument('--features_dir', type=str, default='features/polar/resnet18', help="Root directory for pre-extracted features. If set, this overrides --data_dir.")
    ...
    parser.add_argument('--classes', nargs='+', default=['ref','평탄도'], help='List of class names to train on. Use '+' to group classes, e.g., Ref Particle+Crack')
    parser.add_argument('--method', type=str, default='patch', choices=['resize', 'patch'], help="Method for feature-based training.")
    parser.add_argument('--pooling', type=str, default='transmil', choices=['mean', 'max', 'abmil','transmil'], help="Pooling method for patch-based training.")
